...
(function ($) {
	...
	$.fn.extend({
		...
		function addEvent(event, setMonth, setYear) {
            ...
            for(var index = 1; index <= daysInMonth(setMonth, setYear); index++) {
            	if(index >= startDayNumber && index <= endDayNumber) {
            		...
            		console.log(markupDayStart);
                    $(parent + ' *[data-number="' + index + '"] .monthly-indicator-wrap').append(
                        '<div class = "monthly-event-indicator monthly-event-continued" style="background-color:#fff">&nbsp;</div>');
				}
            }
